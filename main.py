...
def attack(char_name: str, char_class: str) -> str:
    """определяет какой урон нанёс противнику каждый персонаж."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет сколько едениц урона заблокировал каждый персонаж."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определяет силу специального умения для каждого персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Предлагает тренировку для отработки навыков."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбирается один из трёх персонажей игры: воитель, маг, лекарь."""
    approve_choice: str = ''
    char_class: str = ''
